// This template was made by Karjock.
...
(async () => {
    client.on('ready', async () => { // Calling the ready event.
        await client.setActivity({ // Setting the Rich Presence Activity based on what is passed in here.
            buttons: [{ label: "Discord", url: "https://discord.gg/MBM9tNYeqK" }],
            state: "Playing Minecraft",
            details: "[CZ/SK] ⛏HackrisCraft",
            largeImageKey: "diamond_512x512",
            largeImageText: "HackrisCraft"
